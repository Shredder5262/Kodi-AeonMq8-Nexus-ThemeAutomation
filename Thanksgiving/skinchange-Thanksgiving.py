...
import shutil
src = xbmcvfs.translatePath('special://home/userdata/addon_data/skin.aeonmq8.nexus.mod/Thanksgiving/settings.xml')
...
#dialog.ok("Skin settings update", "Thanksgiving Skin settings loaded")