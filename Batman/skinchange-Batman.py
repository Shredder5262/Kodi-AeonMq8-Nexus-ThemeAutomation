#Change the Skin to Estuary so we can load the new MQ 7 settings

#Change to Estuary Skin
...
#Copy the Batman settings
import shutil
src = xbmcvfs.translatePath('special://home/userdata/addon_data/skin.aeonmq8.nexus.mod/Batman/settings.xml')
...
#dialog.ok("Skin settings update", "Batman skin settings loaded")