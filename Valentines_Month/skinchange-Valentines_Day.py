...
#Copy the Thanksgiving settings
import shutil
src = xbmcvfs.translatePath('special://home/userdata/addon_data/skin.aeonmq8.nexus.mod/Valentines_Month/settings.xml')
...
#dialog.ok("Skin settings update", "Valentine's Day Skin settings loaded")