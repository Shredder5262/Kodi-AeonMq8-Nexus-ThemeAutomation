...
#Copy the Christmas settings
import shutil
src = xbmcvfs.translatePath('special://home/userdata/addon_data/skin.aeonmq8.nexus.mod/Christmas/settings.xml')
...
#dialog.ok("Skin settings update", "Christmas skin settings loaded")