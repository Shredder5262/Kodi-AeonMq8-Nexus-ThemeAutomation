...
#Copy the Independence Day settings
import shutil
src = xbmcvfs.translatePath('special://home/userdata/addon_data/skin.aeonmq8.nexus.mod/Independence_Day/settings.xml')
...
#dialog.ok("Skin settings update", "Independence Day skin settings loaded")