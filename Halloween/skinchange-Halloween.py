...
#Copy the Halloween settings
import shutil
src = xbmcvfs.translatePath('special://home/userdata/addon_data/skin.aeonmq8.nexus.mod/Halloween/settings.xml')
...
#dialog.ok("Skin settings update", "Halloween skin settings loaded")