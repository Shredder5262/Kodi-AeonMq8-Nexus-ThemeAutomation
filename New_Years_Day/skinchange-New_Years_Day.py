...
#Copy the New Year's Day settings
import shutil
src = xbmcvfs.translatePath('special://home/userdata/addon_data/skin.aeonmq8.nexus.mod/New_Years_Day/settings.xml')
...
#dialog.ok("Skin settings update", "New Year's Day skin settings loaded")